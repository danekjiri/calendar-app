...
public class ShowEventsCommandTest {
    ...
    public void buildCommand_succeedsIfLoggedIn() throws Exception {
        ...
        // act
        Command command = new ShowEventsCommand().buildCommand(mockUI, mockSession);

        // assert
        assertInstanceOf(ShowEventsCommand.class, command);
    }
    ...
    public void buildCommand_failsIfNotLoggedIn() {
        ...
        assertThrows(InsufficientCommandPrivilegesException.class, () ->
                new ShowEventsCommand().buildCommand(mockUI, mockSession));
    }
}